<%@page import="com.java.www.controller.Mem"%>
...
<html>
	...
	String[] name= {"홍길동","유관순","이순신","강감찬","김구",
			"김유신","홍길자","홍길순","을지문덕","신사임당"};
	String[] hobbies= {"게임,골프,수영","골프,독서","골프","게임,독서","게임,골프,수영,독서",
			"게임,조깅","조깅","게임,골프,수영,조깅,독서","게임","수영,조깅"};
	ArrayList<Mem> list = new ArrayList();
	for(int i=0;i<10;i++){
		list.add(new Mem(id[i],name[i],hobbies[i]));
